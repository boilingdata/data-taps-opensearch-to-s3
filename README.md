...
You need to have [BoilingData account](https://github.com/boilingdata/boilingdata-bdcli) and use it to create a [Data Tap](https://github.com/boilingdata/data-taps-template). The account is used to fetch authorization tokens which allow you to send data to a Data Tap (access control). You can also share write access to other BoilingData users if you like, efficiently creating Data Mesh architectures.
